...
class VulkanCommandBufferUtilBodyGenerator(BaseGenerator):
    ...
    def __init__(self,
        ...
        self.commandBufferCmds = dict()     # List of vulkan commands that dispatch from a VkCommandBuffer object
    ...
    # Method override
    def endFile(self):
        for cmd, info in self.commandBufferCmds.items():
            params = info[2]
    ...
    def generateFeature(self):
        for cmd in self.getFilteredCmdNames():
            self.commandBufferCmds[cmd] = self.featureCmdParams[cmd]
